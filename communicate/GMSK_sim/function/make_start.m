...
%   by S99ST007. For the table lookups are made in SYMBOLS, in 
...
%
% SYMBOLS: The table of symbols corresponding the the state-
%          number.
...
% BY S99ST007. (STATE REPRESENTATION IS SLIGHTLY CHANGED).
%
if Lh == 1
   start_symbols = [ 1 ];
elseif Lh==2
