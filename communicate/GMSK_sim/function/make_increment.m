...
%MAKE_INCREMENT: 
%   This function returns a lookup table containing the 
%   metric increments related to moving from a state n to m. 
%   The data is arranged so that the increment associated 
...
%                 states, as it is generated by the make_next.
%        Rhh:     The autocorrelation as estimated by mf.m.
%
% OUTPUT: INCREMENT: The increment table as described above.
%
% SUB_FUNC: None
%
