...
%   simulator implementations, and is not to be considered 
...
%              parameter is not used in the included channel_simulator 
...
r=I + 1i*Q + random(1:samples).*FACTOR;
r= r + random(samples + 1 : 2*samples).*FACTOR.*1i;
